...
function sendVerificationEmail($recipientEmail, $verificationCode) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'homelybakes2025@gmail.com';
        $mail->Password   = 'ffbu kcjv uqey czgy';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('homelybakes2025@gmail.com', 'Alen@123');
...
<head>
    ...
    <title>Homely Bakes - OTP Verification</title>
