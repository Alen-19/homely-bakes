...
$conn= new mysqli('localhost','root','','homely_bakes');
if ($conn->connect_error) {
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($password==$confirm_password){
            ...
            $sql = "UPDATE table_login SET password = '$hashed_password' WHERE email = '" . $_SESSION['email'] . "'";
...
<head>
    ...
    <title>Homely Bakes - Reset Password</title>
...
<body>
    <div class="login-container">
        <div class="logo">
            <span class="homely">Homely</span><span class="bakes">Bakes</span>
        </div>
